...
public class MouseLook : MonoBehaviour
{
    ...
    [Range(0, 20)] //this sets a slider for the float below
    ...
    private void Update()
    {
        ...
        if (axis == RotationalAxis.MouseXandY)
        {
            ...
            //transform our local position to the next vector3 rotation - y rotation on the x axis and x rotation on the y axis
...
{
    MouseXandY = 0,
    // by default, adds + 1 to the next id so MouseX = 1, MouseY = 2
    MouseX,
